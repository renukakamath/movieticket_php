<?php include'directorheader.php';
  ...
  {
      extract($_POST);
      $q="insert into messages values(null,'director-controller','$lid','$cid','$msg',now())";
      insert($q);
      return redirect("directorchatcontrollers.php?cid=$cid");
  }
              ...
              <div id="demo-chat-body" class="collapse in">
                  <div class="nano has-scrollbar" style="height:380px">
                      <div class="nano-content pad-all" tabindex="0" style="right: -17px;">
                          ...
                          <?php
           $q1="select * from messages where  (sender_id='$lid' and receiver_id='$cid') or (sender_id='$cid' and receiver_id='$lid') ";
          $ch=select($q1);
          foreach ($ch as $key) 
          {
