...
{
	extract($_POST);
	$q="insert into messages values(null,'producer-director','0','$did','$msg',now())";
	insert($q);
    return redirect("producerchatdirector.php?did=$did");
}
    		...
    		<div id="demo-chat-body" class="collapse in">
    			<div class="nano has-scrollbar" style="height:380px">
    				<div class="nano-content pad-all" tabindex="0" style="right: -17px;">
                        ...
                        <?php
		 $q1="select * from messages where (sender_id='0' and receiver_id='$did') or (sender_id='$did' and receiver_id='0') ";
		$ch=select($q1);
		foreach ($ch as $key) 
		{
			if ($key['sender_id']==0) 
