...
<div style="display: flex; width: 800px;gap: 30px;margin-bottom: 250px;">
    ...
    <a class="btn btn-success" href="producerviewdr.php">Chat with Director</a>
    <a class="btn btn-success" href="producerviewact.php">Chat with Actor</a>
    <a class="btn btn-success" href="producerviewcontroler.php">Chat with production Controlller</a>
</div>
</div>
