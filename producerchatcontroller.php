<?php include'producerheader.php';
  ...
  {
      extract($_POST);
      $q="insert into messages values(null,'producer-controller','0','$cid','$msg',now())";
      insert($q);
      return redirect("producerchatcontroller.php?cid=$cid");
  }
              ...
              <div id="demo-chat-body" class="collapse in">
                  <div class="nano has-scrollbar" style="height:380px">
                      <div class="nano-content pad-all" tabindex="0" style="right: -17px;">
                          ...
                          <?php
           $q1="select * from messages where  (sender_id='0' and receiver_id='$cid') or (sender_id='$cid' and receiver_id='0') ";
          $ch=select($q1);
          foreach ($ch as $key) 
          {
              if ($key['sender_id']==0) 
