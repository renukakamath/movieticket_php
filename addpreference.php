...
if(isset($_POST['sub'])){
    extract($_POST);
         ...
         $q="insert into preference values(null,'$oid','$date')";
        insert($q);
...
<div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center" style="display: flex;align-items: center;justify-content:center;width: 100%;">
    ...
    <h2 style="font-size: 30px;color: white;" class="text-white" id="hstyle">Add preference</h2>
...
<table class="table " style="color: black;" >
      ...
      <tr>
        <th style="color: white">preference</th>
        <td >
