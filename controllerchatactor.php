...
{
	extract($_POST);
	$q="insert into messages values(null,'controller-actor','$lid','$actid','$msg',now())";
	insert($q);
    return redirect("controllerchatactor.php?actid=$actid");
}
    		...
    		<div id="demo-chat-body" class="collapse in">
    			<div class="nano has-scrollbar" style="height:380px">
    				<div class="nano-content pad-all" tabindex="0" style="right: -17px;">
                        ...
                        <?php
		 $q1="select * from messages where (sender_id='$lid' and receiver_id='$actid') or (sender_id='$actid' and receiver_id='$lid') ";
		$ch=select($q1);
		foreach ($ch as $key) 
		{
