...
<?php 
    ...
    if(sizeof($qrs)>0){ ?>
        ...
        <tr>
            <td>Producer</td>
            <td>Producer</td>
            <td><a class="btn btn-success" href="controllerviewproducer.php">Chat</a></td>
        </tr>
...
?>
  ...
  ";
    ...
    <tr>
        ...
        <td><a class="btn btn-success" href="controllerchatdirector.php?did=<?php echo $row['rid']?>">Chat</a></td>
        <?php }else if ($row['usertype'] == 'actor') {?>
            <td><a class="btn btn-success" href="controllerchatactor.php?actid=<?php echo $row['rid']?>">Chat</a></td>
