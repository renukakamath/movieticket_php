...
<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1" style="background: linear-gradient(90deg,#000,#000);height: 120px !important;">
						<nav class="link-effect-14" id="link-effect-14">
							<ul class="nav navbar-nav" style="padding-top: 28px;color:red !important;">
								<li ><a href="controllerhome.php"><span>Home</span></a></li>
								<li ><a  href="controllermanageactors.php" ><span ">Manage Actors</span></a></li>
								<li ><a  href="controlerchat.php" ><span ">Chat</span></a></li>
								<li ><a  href="controlerrecentchat.php" ><span ">Recent chat</span></a></li>
